...
export const Header: React.FC<HeaderProps> = ({ activeTab, setActiveTab, onOpenQuickSearch }) => {
  ...
  return (
    <header className="bg-[#07070a]/90 border-b border-white/10 text-[#f3f4f6] sticky top-0 z-40 backdrop-blur-xl shadow-[0_4px_30px_rgba(0,0,0,0.8)] ring-1 ring-white/5">
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-3 sm:gap-4">
          ...
          <div className="flex items-center gap-3.5 sm:gap-5">
            <div className="shrink-0 relative group cursor-pointer">
              ...
              <div className="relative w-13 h-13 sm:w-16 sm:h-16 md:w-18 md:h-18 rounded-2xl sm:rounded-3xl overflow-hidden border-2 border-cyan-400/70 bg-[#0d0d14] p-0.5 shadow-[0_0_28px_rgba(34,211,238,0.28)] transition-transform duration-300 group-hover:scale-105">
                <img
                  src={propheticEmblem}
            ...
            <div className="flex flex-col min-w-0">
              <div className="flex items-center gap-2 mb-0.5">
                <span className="inline-flex items-center gap-1.5 px-2 py-0.5 rounded-full text-[9px] sm:text-[10px] font-mono font-bold uppercase tracking-wider bg-gradient-to-r from-cyan-500/20 to-fuchsia-500/20 text-cyan-300 border border-cyan-500/30">
                  ...
                  <span>Actualidad Bíblica</span>
                </span>
                <span className="hidden sm:inline-block text-[10px] font-mono text-zinc-500">v2.5</span>
              </div>
          ...
          <div className="flex items-center gap-2 self-end sm:self-auto shrink-0 w-full sm:w-auto">
            <button
              ...
              className="w-full sm:w-auto relative group overflow-hidden rounded-xl p-[1px] font-mono text-xs font-bold uppercase tracking-wider transition-all duration-300 active:scale-95 shadow-[0_0_20px_rgba(6,182,212,0.25)] hover:shadow-[0_0_25px_rgba(236,72,153,0.4)] hover:-translate-y-0.5"
            >
          ...
          {tabs.map((tab) => {
            ...
            return (
              <button
                ...
                className={`group relative flex items-center gap-2 px-3.5 sm:px-4 py-2 rounded-xl text-xs font-mono font-bold tracking-wide uppercase transition-all duration-300 whitespace-nowrap shrink-0 hover:-translate-y-0.5 ${
                  isActive
                    ? 'text-black shadow-[0_0_20px_rgba(6,182,212,0.4)] scale-[1.02] ring-1 ring-white/10'
                    : 'text-zinc-400 hover:text-white bg-[#12121a]/80 hover:bg-[#1a1a26] border border-white/5 hover:border-cyan-500/30 hover:shadow-[0_0_12px_rgba(34,211,238,0.18)]'
                }`}
              >
                {isActive && (
